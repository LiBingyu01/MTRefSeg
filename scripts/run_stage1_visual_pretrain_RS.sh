...
DATA_PATH="${1:-${DATA_ROOT}/MTRefSeg_pretrain_RS}"
...
OUTPUT_DIR="${4:-${PROJECT_ROOT}/checkpoint/stage1_visual_change_pretrain_RS}"
GPU_IDS="${5:-0,1,2,3}"
...
RUN_NAME="${RUN_NAME:-stage1_visual_change_pretrain_RS}"
